...
public class StoreController {
    ...
    @PostMapping("/store")
    public void getAllProductsByType(@RequestBody List<Map<String, Object>> products) {
        products.forEach(prod -> productService.save(mapProduct(prod)));
    }

    @PutMapping("/store/{id}")
    public void getAllProductsByType(@PathVariable Long id, @RequestBody Map<String, Object> product) {
